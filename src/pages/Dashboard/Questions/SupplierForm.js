...
const SupplierForm = (props) => {
  ...
  const addSupplier = e => {
    e.preventDefault()
    if (!answer7 || !answer7.match(/^\d{1,}(\.\d{0,2})?$/))
    ...
    <div>
      <Form onSubmit={e => addSupplier(e)}>
        ...
        <Form.Group>
          <Form.Label>
            {' '}
            Which global shipping service is being used by supplier?
          </Form.Label>
          <Form.Control
            as='select'
            value={answer5}
        ...
        <Form.Group>
          <Form.Label>
            Within what distance is considered accessible for you to travel and
            buy your supplies?(in meters )
          </Form.Label>
          <Form.Control
            type='text'
        ...
        <Form.Group>
          <Form.Label>
            Have your suppliers been consistently providing high quality goods?
          </Form.Label>
          <Form.Control
            as='select'
            value={answer10}
