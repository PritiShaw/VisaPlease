    ...
    <div>
      <Form onSubmit={submit}>
        <Form.Group>
          <Form.Label>
            {" "}
            What was your annual revenue last year?(in $)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="$"
        ...
        <Form.Group>
          <Form.Label>
            {" "}
            What is the percentage of business owned by local shareholders(%)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="%"
...
const Question4 = (props) => {
  ...
  const submit = (e) => {
    ...
    if (
      ...
      props.presentAns[
        "company.monthly_payment_deferrals_given_to_customer_before_pandemic"
      ] = answer5;
      props.presentAns[
        "company.monthly_payment_deferrals_received_from_customer_before_pandemic"
      ] = answer6;
      props.setAnswers(props.presentAns);
  ...
  return (
    <div>
      <Form onSubmit={submit}>
        <Form.Group>
          <Form.Label>
            What was your monthly cost before the pandemic? (in $)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="$"
        ...
        <Form.Group>
          <Form.Label>
            What was your monthly revenue before the pandemic? (in $)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="$"
        ...
        <Form.Group>
          <Form.Label>
            How much cash did the company have on hand on a monthly basis before
            the pandemic? (in $)
          </Form.Label>
          <Form.Control
            type="number"
        ...
        <Form.Group>
          <Form.Label>
            How much outstanding debt did the company have on a monthly basis
        ...
        <Form.Group>
          <Form.Label>
            What were the total monthly payment deferrals given to your customer
            before the pandemic? (in $)
          </Form.Label>
          <Form.Control
            type="number"
        ...
        <Form.Group>
          <Form.Label>
            What were the total monthly payment deferrals received from your
            suppliers before the pandemic? (in $)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="$"
...
const Question4b = (props) => {
  ...
  const submit = (e) => {
    ...
    if (
      ...
      props.presentAns[
        "company.monthly_payment_deferrals_given_to_customer"
      ] = answer5;
      props.presentAns[
        "company.monthly_payment_deferrals_received_from_customer"
      ] = answer6;
      props.setAnswers(props.presentAns);
  ...
  return (
    <div>
      <Form onSubmit={submit}>
        ...
        <Form.Group>
          <Form.Label>
            How much cash does the company have on hand this month? (in $)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="$"
        ...
        <Form.Group>
          <Form.Label>
            How much outstanding debt does the company have this month? (in $)
          </Form.Label>
          <Form.Control
            type="number"
            placeholder="$"
        ...
        <Form.Group>
          <Form.Label>
            What is the total payment deferrals given to your customer this
            month? (in $)
          </Form.Label>
          <Form.Control
            type="number"
        ...
        <Form.Group>
          <Form.Label>
            What is the total payment deferrals received from your suppliers
            this month? (in $)
          </Form.Label>
          <Form.Control
            type="number"
  ...
  return (
    <div>
      <Form onSubmit={submit}>
        ...
        <Form.Group>
          <Form.Label>
            Do you provide any online ordering and delivery services?
          </Form.Label>
          <Form.Control
            as="select"
            value={answer2}
        ...
        <Form.Group>
          <Form.Label>
            What social media platforms is your business on? (Checklist:
            Facebook, Facebook Messenger, Instagram, Pinterest, Others )
          </Form.Label>
          <Form.Control
            as="select"
            value={answer3}
