...
import Subscore4Help from "./Subscore4Help";
...
render () {
  ...
  else
  {
    ...
    return (
          <div>
          <Subscore4Help ArrayOfScores={this.state.partscoreArray.slice(this.state.partscoreArray.length-20,this.state.partscoreArray.length)} DateArray={this.state.dateArray}/>
          </div>
      )
  }
}
