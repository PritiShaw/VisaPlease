...
import Subscore3Help from "./Subscore3Help";
...
render () {
  ...
  else
  {
    ...
    return (
          <div>
          <Subscore3Help ArrayOfScores={this.state.partscoreArray.slice(this.state.partscoreArray.length-20,this.state.partscoreArray.length)} DateArray={this.state.dateArray}/>
          </div>
      )
  }
}
